...
>> I installed Python 3. As HackerRnak Python prework is configured for Python3, using Python 3 saves the effort to tweak the code due to version difference. 
